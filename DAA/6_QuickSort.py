...
# Deterministic QuickSort: 5 7 23 32 34 62
# Steps (approx comparisons): 12
# Randomized QuickSort: 5 7 23 32 34 62
# Steps (approx comparisons): 10
# Note: Steps count is an approximation of comparisons made during sorting.
